...
class UserProvider extends StateNotifier<AppUser?> {
  final Ref ref; // Reference to interact with other providers
    ...
    if (user != null) {
      try {
        ...
        if (userData.exists) {
          ...
          debugPrint('User data does not exist in Firestore');
        }
      } catch (e) {
        debugPrint('Failed to load user: $e'); // Log failure to load user data
      }
    }
  }
    ...
    if (user.displayName == null) {
      ...
      if (displayName != null) {
        try {
          ...
          debugPrint('Failed to update display name: $e'); // Log failure to update display name
        }
      }
    }
  }
  ...
  Future<void> updateUser(AppUser updatedUser) async {
    try {
      ...
      debugPrint('Failed to update user in Firestore: $e'); // Log failure to update user data in Firestore
